...
This is the readme for 4X, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. X) > Ok.
...
- To run the project find X.java (which will be in under src/main/java/com/evanshannon/x) and right click > Run 'X'
